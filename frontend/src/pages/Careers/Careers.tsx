...
import { useState } from 'react';
import { useNavigate } from 'react-router-dom';
import { MapPin, Briefcase, Clock, DollarSign, Users, Heart, Zap, Trophy, Code, Palette, TrendingUp, Settings, Search, Filter, X, ArrowRight, CheckCircle, Globe, Coffee, Laptop, Plane, GraduationCap } from 'lucide-react';
import DefaultLayout from '../../layouts/DefaultLayout';
...
const InternCard = ({ intern, onClick }) => {
  ...
  const DeptIcon = departmentIcons[intern.department] || GraduationCap;

  return (
    <div 
      onClick={() => onClick(intern)}
      className="bg-white rounded-xl shadow-lg p-6 hover:shadow-2xl hover:-translate-y-1 transition-all duration-300 cursor-pointer border border-blue-200"
    >
      <div className="flex items-start justify-between mb-4">
        <div className="flex items-center gap-3">
          <div className="w-12 h-12 bg-gradient-to-br from-blue-500 to-blue-600 rounded-lg flex items-center justify-center">
          ...
          <div>
            <span className="text-sm font-semibold text-blue-600">{intern.department}</span>
            {intern.isNew && (
              <span className="ml-2 bg-green-100 text-green-700 text-xs px-2 py-1 rounded-full font-semibold">
                NEW
              </span>
      ...
      <p className="text-gray-600 mb-4 line-clamp-2">{intern.description}</p>
      ...
      <div className="flex flex-wrap gap-2 mb-4">
        ...
        {intern.skills.length > 3 && (
          <span className="text-gray-500 text-xs py-1">+{intern.skills.length - 3} more</span>
        )}
      </div>

      <div className="flex items-center justify-between pt-4 border-t border-blue-200">
        <span className="text-sm text-gray-500">Posted {intern.posted}</span>
        <button className="text-blue-600 font-semibold hover:gap-2 flex items-center gap-1 transition-all">
          View Details
          <ArrowRight className="w-4 h-4" />
        </button>
...
const Careers = () => {
  ...
  const internships = [
    {
      id: 101,
      title: 'Backend Developer Associate (Python)',
      location: 'Remote',
      type: 'Internship',
      department: 'Engineering',
      description: 'Work with our backend team to build scalable APIs and services using Python.',
      ...
      benefits: ['Flexible Hours', 'Remote Work', 'Mentorship', 'Certificate of Completion'],
      responsibilities: [
    ...
    },
    {
      ...
      type: 'Internship',
      department: 'Engineering',
      description: 'Join our development team and contribute to full-stack web applications.',
      ...
      requirements: [
        'Currently pursuing or recently completed degree in IT/CS',
        'Knowledge of JavaScript and React basics',
        'Understanding of web development fundamentals',
        'Problem-solving mindset',
        'Willingness to learn and adapt'
      ],
      benefits: ['Flexible Hours', 'Remote Work', 'Career Growth', 'Certificate of Completion'],
      responsibilities: [
    ...
    },
    {
      ...
      requirements: [
        'Currently pursuing or recently completed degree in Design/UX',
        'Basic understanding of design principles',
        'Proficiency in Figma or similar design tools',
        'Portfolio showcasing design work',
        'Creative thinking and attention to detail'
      ],
      benefits: ['Flexible Hours', 'Remote Work', 'Portfolio Building', 'Certificate of Completion'],
      responsibilities: [
    ...
    },
    {
      ...
      type: 'Internship',
      department: 'HR',
      description: 'Support our HR team with recruitment, onboarding, and employee engagement initiatives.',
      stipend: '$350 - $600/month',
      duration: '3-6 months',
      posted: '5 days ago',
      isNew: false,
      featured: false,
      skills: ['HR Management', 'Recruitment', 'Communication', 'Excel', 'Data Entry'],
      requirements: [
        'Currently pursuing or recently completed degree in HR/Business',
        'Strong communication and interpersonal skills',
        'Attention to detail and organizational skills',
        'Basic Excel knowledge',
        'Passion for helping people'
      ],
      benefits: ['Flexible Hours', 'Remote Work', 'Professional Network', 'Certificate of Completion'],
      responsibilities: [
  ...
  const handleApplyJob = (job) => {
    navigate('/getinfo', { state: { position: job, positionType: 'job' } });
  };

  const handleApplyIntern = (intern) => {
    navigate('/getinfo', { state: { position: intern, positionType: 'internship' } });
  };
    ...
    <DefaultLayout>
      ...
      <div className="bg-gradient-to-br from-blue-50 to-white py-16 px-4">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mt-12">
            <div>
              <div className="text-4xl font-bold text-blue-600 mb-2">{jobs.length + internships.length}</div>
              <div className="text-gray-600">Open Positions</div>
            </div>
            <div>
              <div className="text-4xl font-bold text-blue-600 mb-2">200+</div>
          ...
          <div className="mb-8">
            <div className="flex gap-4 mb-8 border-b border-gray-200">
              <button
                ...
                className={`pb-4 px-2 font-bold text-lg transition-colors ${
                  activeTab === 'jobs'
              ...
              >
                ...
                Full-Time Positions ({jobs.length})
              </button>
              <button
            ...
            <h2 className="text-3xl font-bold text-gray-900 mb-6">
              {activeTab === 'jobs' ? 'Full-Time Positions' : 'Internship Programs'}
            </h2>
            ...
            <div className="relative mb-6">
              ...
              <input
                type="text"
                placeholder={activeTab === 'jobs' ? 'Search positions...' : 'Search internships...'}
                value={searchQuery}
                onChange={(e) => setSearchQuery(e.target.value)}
                className="w-full pl-12 pr-4 py-3 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-600"
              />
            ...
            {/* Results Count */}
            <p className="text-gray-600">
              Showing {activeTab === 'jobs' ? filteredJobs.length : filteredInternships.length} {activeTab === 'jobs' ? (filteredJobs.length === 1 ? 'position' : 'positions') : (filteredInternships.length === 1 ? 'internship' : 'internships')}
            </p>
          </div>
            ...
            <>
              <div className="grid md:grid-cols-2 gap-8">
                {filteredInternships.map((intern) => (
                  <InternCard key={intern.id} intern={intern} onClick={setSelectedIntern} />
                ))}
              </div>
        ...
        >
          ...
          >
            <div className="p-8">
                ...
                <div>
                  <div className="flex items-center gap-2 mb-2">
                    <span className="text-sm font-semibold text-blue-600 flex items-center gap-1">
                      <GraduationCap className="w-4 h-4" /> {selectedIntern.department}
                    </span>
                    {selectedIntern.isNew && (
                      <span className="bg-green-100 text-green-700 text-xs px-2 py-1 rounded-full font-semibold">
                        NEW
                      </span>
                    )}
                  </div>
                  <h2 className="text-3xl font-bold text-gray-900 mb-2">{selectedIntern.title}</h2>
                  <div className="flex flex-wrap gap-4 text-sm text-gray-600">
                    <div className="flex items-center gap-1">
                      <MapPin className="w-4 h-4" />
              ...
              <div className="space-y-6 max-h-[60vh] overflow-y-auto pr-2">
                <div>
                  <h3 className="text-xl font-bold text-gray-900 mb-3">About the Internship</h3>
                  <p className="text-gray-600 leading-relaxed">{selectedIntern.description}</p>
                </div>
                ...
                <div>
                  <h3 className="text-xl font-bold text-gray-900 mb-3">Benefits</h3>
                  <div className="grid grid-cols-2 gap-3">
                    {selectedIntern.benefits.map((benefit, idx) => (
                      <div key={idx} className="flex items-center gap-2 text-gray-700">
              ...
              <div className="flex gap-4 pt-6 mt-6 border-t border-gray-200">
                <button
                  onClick={() => {
                    handleApplyIntern(selectedIntern);
