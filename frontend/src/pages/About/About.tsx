...
// import { Target, Eye, Award, Users, Lightbulb, TrendingUp, Globe, Shield, Heart, Zap, BookOpen, Rocket } from 'lucide-react';
// import Card from '../../components/Card';

// const About = () => {
//   const milestones = [
//     { year: '2015', title: 'Founded', description: 'Started with a vision to revolutionize technology solutions' },
//     { year: '2018', title: 'Global Expansion', description: 'Expanded operations to 15 countries worldwide' },
//     { year: '2021', title: 'Industry Recognition', description: 'Awarded Best Tech Innovator of the Year' },
//     { year: '2024', title: 'Continued Growth', description: 'Serving 10,000+ satisfied clients globally' }
//   ];
...
//               From humble beginnings to global impact, our journey has been defined by innovation and dedication.
//             </p>
//           </div>
...
//                 commitment to our clients. Today, we serve thousands of businesses across 50+ countries, helping 
//                 them navigate the digital landscape and achieve their goals.
//               </p>
//               <p className="text-gray-700 leading-relaxed">
//                 We believe that technology should be a catalyst for positive change, and we're dedicated to 
//                 building solutions that not only solve problems but also create new opportunities for growth 
//                 and success.
//               </p>
//             </div>
...
//               <p className="text-gray-600">
//                 With presence in over 50 countries, we understand diverse markets and deliver 
//                 localized solutions that resonate with your audience.
//               </p>
//             </Card>
//             <Card>
...
//               <p className="text-gray-600">
//                 Years of experience and thousands of successful projects demonstrate our ability 
//                 to deliver results that exceed expectations.
//               </p>
//             </Card>
//             <Card>
//               <Rocket className="w-12 h-12 text-blue-600 mb-4" />
//               <h3 className="text-2xl font-bold mb-3">Future-Ready Solutions</h3>
//               <p className="text-gray-600">
//                 We stay ahead of technology trends to ensure your business is equipped with 
//                 solutions that scale and adapt to future needs.
//               </p>
//             </Card>
//           </div>
//         </div>
    ...
    <DefaultLayout>
      ...
      <div className="relative bg-gradient-to-br from-blue-600 via-blue-700 to-indigo-800 py-24 px-4 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          <h1 className="text-6xl font-bold text-white mb-6 leading-tight">About Us</h1>
